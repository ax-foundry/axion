...
<a href="https://github.com/ax-foundry/axion" style="color: white; text-decoration: none;">Axion</a> provides a composable suite of AI tools—each designed as a <strong>plug-and-play building block</strong> to accelerate development and reinforce best practices across your AI stack. These are not frameworks that take over your pipeline—they're <strong>modular enhancements</strong> that snap into place where you need them.
</p>
</div>
...
<strong>Reusable by Default</strong> |
...
[![Modular](https://img.shields.io/badge/-Modular-blue?style=for-the-badge)](#)
[![Composable](https://img.shields.io/badge/-Composable-green?style=for-the-badge)](#)
[![Production Ready](https://img.shields.io/badge/-Production%20Ready-orange?style=for-the-badge)](#)
[![Open Source](https://img.shields.io/badge/-Open%20Source-purple?style=for-the-badge)](#)
